...
//        else if("学生".equals(role))
//            zhaopinYuyue.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        if("".equals(zhaopinYuyue.getZhaopinYuyueText()) || "null".equals(zhaopinYuyue.getZhaopinYuyueText())){
                zhaopinYuyue.setZhaopinYuyueText(null);
        }
        if("".equals(zhaopinYuyue.getZhaopinYuyueYesnoText()) || "null".equals(zhaopinYuyue.getZhaopinYuyueYesnoText())){
                zhaopinYuyue.setZhaopinYuyueYesnoText(null);
        }
...
//                            zhaopinYuyueEntity.setYonghuId(Integer.valueOf(data.get(0)));   //学生 要改的
//                            zhaopinYuyueEntity.setZhaopinId(Integer.valueOf(data.get(0)));   //招聘 要改的
//                            zhaopinYuyueEntity.setZhaopinYuyueText(data.get(0));                    //备注 要改的
//                            zhaopinYuyueEntity.setZhaopinYuyueYesnoTypes(Integer.valueOf(data.get(0)));   //报名状态 要改的
//                            zhaopinYuyueEntity.setZhaopinYuyueYesnoText(data.get(0));                    //回复 要改的
    ...
    */
    ...
    public R add(@RequestBody ZhaopinYuyueEntity zhaopinYuyue, HttpServletRequest request){
        ...
        Wrapper<ZhaopinYuyueEntity> queryWrapper = new EntityWrapper<ZhaopinYuyueEntity>()
            .eq("yonghu_id", zhaopinYuyue.getYonghuId())
            .eq("zhaopin_id", zhaopinYuyue.getZhaopinId())
            .in("zhaopin_yuyue_yesno_types", new Integer[]{1})
//            .notIn("zhaopin_yuyue_types", new Integer[]{102})
        ...
        zhaopinYuyueService.insert(zhaopinYuyue);
            ...
            if(zhaopinYuyueEntity.getZhaopinYuyueYesnoTypes()==1)
                return R.error(511,"该用户已经投递了该职位,请等待审核");
            else if(zhaopinYuyueEntity.getZhaopinYuyueYesnoTypes()==2)
                return R.error(511,"有相同的审核通过的数据");
            else
                return R.error(511,"表中有相同数据");
