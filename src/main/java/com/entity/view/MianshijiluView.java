...
public class MianshijiluView extends MianshijiluEntity implements Serializable {
	...
	* 面试结果的值
	*/
	@ColumnInfo(comment="面试结果的字典表值",type="varchar(200)")
	private String mianshijiluValue;
	...
	* 获取： 面试结果的值
	*/
	public String getMianshijiluValue() {
		return mianshijiluValue;
	}
	/**
	* 设置： 面试结果的值
	*/
	public void setMianshijiluValue(String mianshijiluValue) {
		this.mianshijiluValue = mianshijiluValue;
	}
	...
	public String toString() {
		return "MianshijiluView{" +
			", mianshijiluValue=" + mianshijiluValue +
