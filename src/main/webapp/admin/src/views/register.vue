    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">大学生勤工助学管理系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <el-form-item label="用工部门名称" class="input" v-if="tableName=='gongsi'">
                            <el-input v-model="ruleForm.gongsiName" autocomplete="off" placeholder="用工部门名称"  />
                        </el-form-item>
                       <!--<el-form-item class="input" label="用工部门类型">
                            <el-select style="width: 399px;height: 40px;" v-model="ruleForm.gongsiTypes" placeholder="请选择用工部门类型">
                                <el-option
                        ...
                        <!--
                            ...
                            <el-form-item label="用工部门封面" class="input" v-if="tableName=='gongsi'">
                                    <file-upload
                                        tip="点击上传用工部门封面"
                                        action="file/upload"
                                        :limit="1"
                        ...
                        -->
                        <!--
                            <el-form-item label="用工部门介绍" class="input" v-if="tableName=='gongsi'">
                                <el-input type="textarea" v-model="ruleForm.gongsiContent" placeholder="用工部门介绍"></el-input>
                           </el-form-item>
                        -->
                        <!--
                       ...
                       <!--<el-form-item class="input" label="院系">
                            <el-select style="width: 399px;height: 40px;" v-model="ruleForm.yuanxiTypes" placeholder="请选择院系">
                                <el-option
                       ...
                       <!--<el-form-item class="input" label="年级">
                            <el-select style="width: 399px;height: 40px;" v-model="ruleForm.nianjiTypes" placeholder="请选择年级">
                                <el-option
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            // yonghu 中的 院系 判空处理
                            // if('yonghu' == this.tableName && (this.ruleForm.yuanxiTypes== null ||this.ruleForm.yuanxiTypes== "")){
                            ...
                            // }
                            // yonghu 中的 年级 判空处理
                            // if('yonghu' == this.tableName && (this.ruleForm.nianjiTypes== null ||this.ruleForm.nianjiTypes== "")){
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/qingongjianxue/img/back-img-bg.jpg);
